...
void test_IplImage()
{
	...
	IplImage* img2 =cvCreateImage(cvSize(50,50), IPL_DEPTH_8U, 1);//创建目标图像
	cvCvtColor(img1,img2,CV_BGR2GRAY);//灰度化图片
	lcd_show_pic(img2,100,200);
	cvReleaseImage(&img1);

	
	IplImage* img3 =cvCreateImage(cvSize(50,50), IPL_DEPTH_8U, 1);//创建目标图像
	cvCanny( img2, img3, 3, 9,3 );
	lcd_show_pic(img3,0,200);
